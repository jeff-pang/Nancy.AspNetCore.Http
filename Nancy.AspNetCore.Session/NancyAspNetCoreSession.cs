...
{
    internal class NancyAspNetCoreSession : NancySession.ISession
    {
        ...
        internal class NancyAspNetCoreSessionIterator : IEnumerator<KeyValuePair<string, object>>
        {
            ...
            private AspHttp.ISession httpSession
            {
                get
                {
        ...
        internal NancyAspNetCoreSession(AspHttp.ISession httpSession)
        {
